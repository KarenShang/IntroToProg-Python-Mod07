...
Open file via PyCharm. Click create new project, name it as Assignment07, and save it under _PythonClass in C: drive (Figure 1).
 ...
 ![Figure 1](https://github.com/KarenShang/IntroToProg-Python-Mod07/blob/master/docs/1.png "Result of listing 1")####
...
![Figure 10](https://github.com/KarenShang/IntroToProg-Python-Mod07/blob/master/docs/10.png) 
